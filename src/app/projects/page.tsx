...
// Public DePM page: projects whose owners chose to make a board public. Read-only; readable signed-out.
    ...
    <div className="relative flex h-screen flex-col overflow-hidden bg-slate-950">
      ...
      <div className="relative z-10 flex min-h-0 flex-1">
        ...
        <main className="flex min-h-0 flex-1 flex-col overflow-y-auto">
          <div className="mx-auto w-full max-w-5xl flex-1 px-4 pb-10 pt-6 sm:px-6"><ProjectsView /></div>
          <Footer />
        </main>
      </div>
    </div>
